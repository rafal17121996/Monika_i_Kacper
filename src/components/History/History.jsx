      ...
      <div style={{ backgroundImage: `url(${img})` }} className={style("")}>
        {isMobile ? null : (
            <p className={style("text1")}>
              ...
              jednak rodzice postanowili, że pójdzie jednak do szkoły za rok ze
              ...
              Skrajne! Monika była przerażona, Kacper skakał z radości.
              Spotkalisię trzy dni później i Monika wyznała Kacprowi miłość! Co za
